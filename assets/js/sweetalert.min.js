    ...
    return r = {}, o.m = n = [function (t, e, n) {
                ...
                for (var n = 0; n < t.length; n++) {
                    ...
                    if (r) {
                        ...
                        for (; i < o.parts.length; i++)
                            r.parts.push(p(o.parts[i], e))
                    } else {
                        for (var a = [], i = 0; i < o.parts.length; i++)
                            a.push(p(o.parts[i], e));
                        b[o.id] = {
                            id: o.id,
                            refs: 1,
                            parts: a
            ...
            "undefined" == typeof window || window.Promise || (window.Promise = o), n(21), String.prototype.includes || (String.prototype.includes = function (t, e) {
                ...
                value: function (t, e) {
                    ...
                    for (var r, i, e = 0 | e, a = Math.max(0 <= e ? e : o - Math.abs(e), 0); a < o; ) {
                        if ((r = n[a]) === (i = t) || "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))
                            return !0;
                        a++
                    }
                    return !1
            ...
            (function (e) {
                    ...
                    try {
                        ...
                        if (e && ("object" == typeof e || "function" == typeof e)) {
                            ...
                            if ("function" == typeof n)
                                return void u((o = n, r = e, function () {
                                    o.apply(r, arguments)
                                }), t)
                        }
                ...
                t = this, n = setTimeout, i.prototype.catch = function (t) {
                    ...
                    return new i(function (r, i) {
                        if (0 === s.length)
                            return r([]);
                        for (var a = s.length, t = 0; t < s.length; t++)
                            !function e(n, t) {
                                try {
            ...
            function o(t, e, n) {
                ...
                "input" === e && ((r = i).addEventListener("input", function (t) {
                    ...
                    if ("Enter" === t.key)
                        return u.onAction(c.CONFIRM_KEY)
                }), setTimeout(function () {
            ...
            function r(t) {
                if (c.default.isOpen && "Tab" === t.key)
                    return t.preventDefault(), void b()
            }

            function i(t) {
                if (c.default.isOpen)
                    return "Tab" === t.key && t.shiftKey ? (t.preventDefault(), void g()) : void 0
            }
