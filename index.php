                ...
                <div class="container container-bg-set style-wave wave">
                    <div class="row wow fadeInLeft top-margin1">  
                        <div class="col-md-6 col-sm-12 text-left pt-100 text-white">                  
                            ...
                            <p class="text-justify">Make the perfect online Topik Test EXam ! Get the flexibility you need to get the answers you want. The Topik test korea  by kiran chhetri makes it easy for you to Test Topik Exam.</p>
                ...
                <div class="row pt-4">
                    <div class="col-md-3 col-sm-6">
                        <div class="shadow-box feature-box wow zoomIn text-center">
                            ...
                            <div class="hight-box">
                                <p>Topik Test Online  designed exclusively for learn with fun ,You have 75 seconds to answer each question. The faster you answer, the higher your score.</p>
                            </div>        
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="shadow-box feature-box wow zoomIn text-center">
                            ...
                            <div class="hight-box">
                                <p>lifelines is the most fun feature with Eps-Topik  quiz it will help the users to keep more active with learning.</p>
                            </div>
                        </div>                            
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="shadow-box feature-box wow zoomIn text-center">
                            ...
                            <div class="hight-box">
                                <p>let's make fun with self UBT-Exam challenge  with self-improvement, here user can make self challenge with time, category, questions and many more!</p>
                            </div>    
                        </div>                        
                    </div>
                    <div class="col-md-3 col-sm-6">
                    ...
                    <div class="row wow fadeInLeft">
                        ...
                        <div class="col-md-6 col-sm-12 py-4">
                            ...
                            <div class="text-justify">
                                ...
                                <p>With the super database of questions and always adding more, Eps-Topik Quiz will test your Knowledge to the fullest.</p>
                            </div>
                            <div class="pt-4">
                ...
                <div class="container-bg-set container mb-40">
                    <div class="row wow fadeInRight">
                        <div class="col-md-6 col-sm-12 py-4">
                            ...
                            <div class="text-justify">
                                <p>user can battel topik question with friends.10 question in battel and give 75 S for every question..</p>
                ...
                <div class="container-bg-set container mb-40">
                    <div class="row wow fadeInLeft">
                        ...
                        <div class="col-md-6 col-sm-12 py-4">
                            ...
                            <div class="text-justify">
                                <p>user  can test new eps topik UBT  system exam question.  user can select custom question and time and test reading question and listening question. </p>
