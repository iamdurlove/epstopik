...
if (!isset($_POST['userId1']) && !isset($_POST['player1Name']) && !isset($_POST['opp_name'])) {
...
<html lang="en">
    ...
    <body class="bg-content-color">
                                ...
                                <div class="table_q w-100 mt-1">
                                    <div class="tbody_q">
                                        <div class="tr_q">
                                            ...
                                            <div class="td_q text-center"><?= htmlspecialchars($opp_user) ?></div>                                        
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            date = "<?= date('Y-m-d') ?>";
            opp_user_name = "<?= htmlspecialchars($_POST['opp_name']) ?>";
            curr_user_id = "<?= htmlspecialchars($_POST['userId1']) ?>";
        </script>

        <script src="assets/js/pages/battle-robot.js"></script>
    </body>
</html>